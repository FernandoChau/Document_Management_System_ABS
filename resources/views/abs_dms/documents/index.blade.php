            ...
            <main class="flex flex-col h-full w-full overflow-auto ">
                <div
                    ...
                    <div class="w-1/2 h-full flex items-center justify-end">
                        ...
                        <button @click="window.location.href = '{{route('dashboard.all')}}'"
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody
                                            ...
                                            <tr class="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 active:bg-gray-200"
                                                ...
                                                <td class="px-5 py-4 sm:px-6">
                                                    <div
                                                        ...
                                                        <button @click="window.location='{{ route('folders.download', $folder->id) }}'"
                                                            class="h-7 w-7 flex items-center justify-center rounded-full hover:bg-gray-300 dark:hover:bg-gray-900">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                                class="size-4">
                                                        ...
                                                        @if ($folder->is_removable && $folder->created_by == auth()->user()->id || auth()->user()->role == 'admin')
                                                            <button
                                                        ...
                                                        @else
                                                            <button
                                                                class="h-7 w-7 cursor-not-allowed opacity-40 flex items-center justify-center rounded-full hover:bg-gray-300 dark:hover:bg-gray-900">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                                    class="size-4">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    @foreach ($files as $file)
                                        @if ($parentId == $file->folder_id && $file->is_accessible == true && $file->deleted_at == null)
                                        ...
                                        @elseif ($parentId == $file->folder_id && $file->is_accessible == false && $file->deleted_at == null)
                                            <tr @dblclick="window.open('{{ route('files.preview', $file->id) }}', '_blank')"
