...
import { Upload, Trash2, AlertCircle as AlertCircleIcon, CheckCircle, XCircle, Loader2 } from "lucide-react";
...
export function FileUploadModal({
  ...
  const handleSave = async () => {
    ...
    try {
      // Se houver callback customizado onUpload, usar esse
      if (onUpload) {
        await onUpload(validFiles);
      } else {
        // Caso contrário, usar uploadDocument com progresso
        ...
        await uploadDocument(folderId, validFiles, onProgress);
      }
