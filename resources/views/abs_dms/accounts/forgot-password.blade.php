        ...
        <div class=" w-[550px] max-w-[550px] px-8 py-5 flex flex-col bg-white rounded-xl border border-gray-200">
            ...
            <div class="relative py-1 px-5 sm:py-1">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class=" text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">Recupere sua senha</span>
                </div>
            </div>

            <span class=" mt-2 text-md text-gray-500 text-center text-wrap">
                Deixe ficar aqui o seu email que nós te ajudamos no processo de recuperção.
            </span>

            <form class="flex flex-col gap-3 mt-1" action="{{ route('password.email') }}" method="POST">
                @csrf
                <div>
