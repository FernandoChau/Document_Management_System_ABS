...
export default function UserDropdown() {
  ...
  const displayEmail = user?.email ?? "sem-email@dominio.com";
    ...
    <div className="relative">
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-left text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 disabled:opacity-60"
        >
          {isLoggingOut ? "A encerrar..." : "Encerrar Sessao"}
        </button>
      </Dropdown>
    </div>
  );
