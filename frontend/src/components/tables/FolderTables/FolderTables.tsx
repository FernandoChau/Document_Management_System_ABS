...
import { DownloadIcon, FolderIcon, MoreDotIcon, PaperPlaneIcon, PencilIcon, PlugInIcon, TrashBinIcon } from "../../../icons";
import { DocumentIcon, DocumentTextIcon, FolderIcon as FolderSolid } from '@heroicons/react/24/solid';
