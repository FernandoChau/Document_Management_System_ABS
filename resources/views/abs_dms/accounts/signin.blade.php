...
<body
  ...
  <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
    <div
      ...
      <div class="flex flex-col flex-1 w-full lg:w-1/2">
        ...
        <div
          ...
          <div>
            ...
            <div class="relative py-1 sm:py-1">
              ...
              <div class="relative flex justify-center text-sm">
                <span
                  class="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">Entrar</span>
              </div>
            </div>
            <div>
                ...
                <div class="space-y-5">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <a
                      ...
                      class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Esqueci a password</a>
                  </div>
                  <!-- Validation Errors -->
              ...
              <div class="mt-5">
                <p
                  ...
                  <a
                    href="{{ route('register') }}"
                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Criar Conta</a>
                </p>
              </div>
              {{-- <div class="mt-5">
                  <p
      ...
      <div
        class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-brand-900 lg:grid lg:w-1/2">
        <div class="flex items-center justify-center z-1">
          <!-- ===== Common Grid Shape Start ===== -->
          @include('abs_dms/partials/common-grid-shape')
          <div class="flex flex-col items-center max-w-xs">
            <a href="" class="block mb-4">
              <img width="100" height="100" src="{{asset('images/logo/logo-abs.svg')}}" alt="Logo" />
            </a>
            <p class="text-center text-gray-400 dark:text-white/60">
              Seja muito bem-vindo a plataforma de Gestão de Ficheiros da ABS
            </p>
          </div>
        </div>
      </div>
