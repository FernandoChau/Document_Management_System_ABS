<div x-show="isConfirmUserModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
    <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/25 backdrop-blur-[1px]"></div>
    <div @click.outside="isConfirmUserModal = false"
        ...
        <button @click="isConfirmUserModal = false"
        ...
        <form class="flex flex-col" x-bind:action="'{{ route('user.confirm', '__ID__') }}'.replace('__ID__', confirmUserData.id)" method="POST">
            @method('PUT')
            @csrf
            <div class="flex flex-col gap-5 px-2 overflow-y-auto custom-scrollbar">
                <div class="flex flex-col gap-x-6 gap-y-5">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            x-model="confirmUserData.profission"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    </div>
                    ...
                    <div>
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select x-model="confirmUserData.role" name="role"
            ...
            <div class="flex items-center gap-3 mt-6 lg:justify-end">
                <button @click="isConfirmUserModal = false" type="button"
