<div
  x-show="isProfileResetPasswordModal"
...
>
  ...
  ></div>
  <div
    @click.outside="isProfileResetPasswordModal = false"
  ...
  >
    <!-- close btn -->
    <button
      @click="isProfileResetPasswordModal = false"
    ...
    <form class="flex flex-col" action="{{ route('user-password.update') }}" method="POST">
      @method('PUT')
      @csrf
